...
import math
import datetime
URL_STEM = 'https://stage.api.jockmkt.net/v0.2'
...
#umarbek@jockmkt.com
#testpass123_
t = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c3JfNjQ5ZjFlOWMxY2Q4OGEzOTJjYmIxYmViNjZiMzMyODkiLCJyb2xlIjoiYXBwX3VzZXIiLCJpYXQiOjE1Nzg0MjcwNTgsIm5iZiI6MTU3ODQyNzA1OCwiZXhwIjoxNTgxMDE5MDU4fQ.oS0GnEQbuMF_fKDXApA8XOtrvE6STcrd44oZarnqUt4'
event0 = 'evt_d95b8e01de0284c3e957cccf865444c5'

#'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c3JfOTgwZWUzNjFkMmI2OWNkNmE2OGUwNjM0MzUxNTkzNTgiLCJyb2xlIjoiYXBwX3VzZXIiLCJpYXQiOjE1Nzg0Mjg1MDEsIm5iZiI6MTU3ODQyODUwMSwiZXhwIjoxNTgxMDIwNTAxfQ.Gsshj4IJFtcbtS2opbVetQmcw16XFTW4MHu7gyyaAlw'
...
def submitLiveOffers(token):
    ...
    for ue in userEventsLive:
        ...
        holdingsIds = {holding['eventstock_id']: holding['selling_power'] for holding in holdings} #available might be selling_power in v2
